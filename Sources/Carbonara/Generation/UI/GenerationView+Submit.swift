...
extension GenerationView {
    ...
    var submitButton: some View {
        Button {
            ...
            Image(systemName: aiAllowed ? "arrow.up" : "key.fill")
        ...
        .opacity((aiAllowed && !canSubmit) ? AppTheme.Opacity.strong : AppTheme.Opacity.opaque)
        .help(aiAllowed ? "" : "Add a provider API key to generate")
    }
