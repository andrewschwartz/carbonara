...
struct WelcomeOverlay: View {
    ...
    private var card: some View {
        VStack(alignment: .leading, spacing: AppTheme.Spacing.lg) {
            VStack(alignment: .leading, spacing: AppTheme.Spacing.sm) {
                Text("Welcome to Carbonara")
                    .font(.system(size: AppTheme.FontSize.title2, weight: .light))
                    .tracking(AppTheme.Tracking.tight)
                    .foregroundStyle(AppTheme.Text.primaryColor)
                Text("The AI-native post tool. Edit, generate, and finish — with your own models.")
    ...
    private static func loadHero() -> NSImage? {
        ...
        let candidates = [
            ...
            root.appendingPathComponent("Carbonara_Carbonara.bundle/Images/welcome-butterfly.jpg"),
        ]
