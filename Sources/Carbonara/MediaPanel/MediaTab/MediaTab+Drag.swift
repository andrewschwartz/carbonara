...
extension MediaTab {
    static let folderDragScheme = "carbonara-folder://"
    static let assetDragScheme = "carbonara-asset://"
    static let timelineDragScheme = "carbonara-timeline://"
    ...
    /// A search "moment": `carbonara-asset://<id>#<start>-<end>` in source seconds
