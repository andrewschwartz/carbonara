...
final class SampleProjectService {
    ...
    /// Sample hosting was Carbonara infrastructure; disabled until Carbonara hosts its own samples.
    ...
    private static func cacheRoot() -> URL {
        ...
        return base.appendingPathComponent("Carbonara/Samples", isDirectory: true)
    }
