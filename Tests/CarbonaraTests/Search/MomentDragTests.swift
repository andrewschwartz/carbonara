...
struct MomentDragTests {
    ...
    @Test func malformedSegmentsRejected() {
        #expect(MediaTab.assetSegment(fromDragString: "carbonara-asset://x#5-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "carbonara-asset://x#-1-2") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "carbonara-asset://x#junk") == nil)
        #expect(MediaTab.assetSegment(fromDragString: "carbonara-folder://x#1-2") == nil)
        #expect(MediaTab.assetId(fromDragString: "carbonara-asset://x#junk") == "x")
    }
